...
def lookup(driver):
    ...
    # print(optionValuesCombination[20:25])

    # time.sleep(5)
    for x in range(72001, 108000):
...
def excel_file(rows):
    ...
    with open('/home/apptrinity19/development/scraping/web_scraper/files/banner_3_' + str(date.today()) +  '.csv', 'w', newline='') as f_output:
