...
def lookup(driver):
    driver.get('https://www.m13.com/product/catalog-printing')
    ...
    for x in range(len(optionValuesCombination)):
        ...
        selectBindingPlace.select_by_value(str(optionValuesCombination[x][8]))
        # print(x)
        ...
        if optionValuesCombination[x][8] in selectBindingPlaceValues:
        ...
        try:
            ...
            rows.append([
                ...
                service_prices[3][1], 
                service_days[3], 
                'Exact Quantity=0, PRINT SIZE={}, EXACT SIZE=0, SIDES={}, PAPER OR STOCK={}, COATING={}, PAGES={}, COLOR CRITICAL=0, COVER PAPER TYPE={}, BINDING={}, Wafer Seal=0'.format(selectPrintSizeText, selectSidesText, selectPaperStockText, selectCoatingText, selectCPTypeText, selectPageText, selectBindingText, selectBindingPlaceText), 
...
def excel_file(rows):
    ...
    with open('/home/apptrinity19/development/scraping/web_scraper/files/catalog_' + str(date.today()) +  '.csv', 'w', newline='') as f_output:
